...
time_series_stack_N(list(country_confirmed_cases_daily("Germany", per_country_ts.data),
												 country_confirmed_cases_daily("Cz", per_country_ts.data),
												 country_confirmed_cases_daily("Zeal", per_country_ts.data)))

time_series_stack_N(list(country_confirmed_cases_daily("Belgium", per_country_ts.data),
												 country_confirmed_cases_daily("Belgium", per_country_deaths.data, barfill = "#9b2335", smoothcol = "#ff944d")))
